...
import { ICypressPost10Configuration, ICypressPre10Configuration } from "@badeball/cypress-configuration/lib/cypress-configuration";
export declare function getStepDefinitionPaths(configuration: {
