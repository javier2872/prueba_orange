...
function getStepDefinitionPatternsPre10(configuration, filepath) {
    ...
    const stepDefinitions = configuration.preprocessor.stepDefinitions
        ? [configuration.preprocessor.stepDefinitions].flat()
        : preprocessor_configuration_1.DEFAULT_PRE_10_STEP_DEFINITIONS.map((pattern) => pattern.replace("[integration-directory]", (0, helpers_1.ensureIsRelative)(configuration.cypress.projectRoot, configuration.cypress.integrationFolder)));
